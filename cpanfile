...
requires_by_perl 'DBI',
	prior 5.012 => '==1.651',   # 1.652 requires perl 5.12 in its Makefile.PL
	;
...
requires_by_perl 'Pod::Usage',          # Dependency of Plack
	prior 5.010 => skip,    # Plack already skipped for < 5.010; v1.70 no longer installs on 5.8
	otherwise  skip
	;
...
# Carton::Snapshot is not a testing module, but the ci-perl-tester-helpers
# scripts and cpm's snapshot support expect it; docker-perl-tester installed
# it from its Dockerfile rather than from here. -- claude, 2026-09-05
requires_by_perl 'Carton::Snapshot',
	;
